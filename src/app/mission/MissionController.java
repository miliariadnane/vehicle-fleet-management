    ...
    void addMission(ActionEvent event)  {
        ...
        try {
            Statement statement = connection.createStatement();
                ...
                //  driver  
                statement.execute("insert into missions values('" + idM + "','" + lib + "','" + vehi + "','" + condu + "','" + typeV + "','" + desc + "', '" + dateDebut + "', '" + dateFin + "', '" + perce + "')");
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            while(rs.next()){
                ...
                vehiculesAL.add(new Vehicule (rs.getString(1), rs.getString(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6)) );
