...
public class assuranceModule extends Vehicule{
    ...
    public assuranceModule(int nombreJour, String matricule, String marqueV, String typeCarb, String dateAssur, String dateAssur2, String dateVidange) {
        super(matricule, marqueV, typeCarb, dateAssur, dateAssur2, dateVidange);
        this.nombreJour = nombreJour;
    }

    public assuranceModule(int nombreJour) {
        this.nombreJour = nombreJour;
    }
